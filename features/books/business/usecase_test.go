...
func TestGetAllBook(t *testing.T) {
	t.Run("Test Get All Book Success", func(t *testing.T) {
		bookBusiness := NewBookBusiness(mockBookData{})
		result, err := bookBusiness.GetAllBook(0, 0)
		assert.Nil(t, err)
		assert.Equal(t, "Kamus", result[0].Title)
	})

	t.Run("Test Get All Book Failed", func(t *testing.T) {
		bookBusiness := NewBookBusiness(mockBookDataFailed{})
		result, err := bookBusiness.GetAllBook(0, 0)
		assert.NotNil(t, err)
		assert.Nil(t, result)
	})
...
func TestCreateNewBook(t *testing.T) {
	t.Run("Test Create New Book Success", func(t *testing.T) {
		...
		result, err := bookBusiness.CreateNewBook(newBook)
		assert.Nil(t, err)
...
func TestUpdatedBook(t *testing.T) {
	t.Run("Test Updated Book Success", func(t *testing.T) {
		...
		result, err := bookBusiness.UpdatedBook(0, updBook)
		assert.Nil(t, err)
...
func TestSoftDeleteBook(t *testing.T) {
	t.Run("Test Soft Delete Book Success", func(t *testing.T) {
		bookBusiness := NewBookBusiness(mockBookData{})
		var id = 0
		result, err := bookBusiness.SoftDeleteBook(id)
		assert.Nil(t, err)
		assert.NotNil(t, 1, result)
	})
...
func TestSelectBookByCategory(t *testing.T) {
	t.Run("Test Select Book By Category Success", func(t *testing.T) {
		...
		result, err := bookBusiness.SelectBookByCategory(ctg.Category)
		assert.Nil(t, err)
...
func TestSelectBookByUserId(t *testing.T) {
	t.Run("Test Select Book By User Id Success", func(t *testing.T) {
		bookBusiness := NewBookBusiness(mockBookData{})
		result, err := bookBusiness.SelectBookByUserId(1)
		assert.Nil(t, err)
		assert.NotNil(t, 1, result[0].User.ID)
	})
	t.Run("Test Select Book By User Id Failed", func(t *testing.T) {
		bookBusiness := NewBookBusiness(mockBookDataFailed{})
		result, err := bookBusiness.SelectBookByUserId(2)
		assert.NotNil(t, err)
		assert.Nil(t, result)
	})
}
